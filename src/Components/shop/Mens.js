        ...
        <>
            <div className="menshop">
                ...
                <svg id="svg" viewBox="0 40 200 200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill="#BBECFF" d="M61.3,-47.7C70.9,-36.8,64.4,-11.8,56.3,8.6C48.2,28.9,38.6,44.6,22.9,54.9C7.3,65.3,-14.5,70.3,-34.6,63.7C-54.7,57.2,-73.2,39,-77.3,18.4C-81.4,-2.2,-71.1,-25.3,-55.8,-37.5C-40.5,-49.7,-20.3,-51,2.8,-53.2C25.8,-55.4,51.6,-58.6,61.3,-47.7Z" transform="translate(100 100)" />
                </svg>
            </div> */}
                            ...
                            <>
                                ...
                                <NavLink to={`/product/${value.id}`}>
                                    <div class="carditems text-center" >
                                        <img class="carditemimg text-center" src={value.img} alt="Card image cap" />
                                        <div class="card-body">
